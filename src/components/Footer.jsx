  ...
  return (
      <footer className='py-5 sm:px-10 px-5'>
          <div className="screen-max-width">
              ...
              <div className="flex md:flex-row flex-col md:items-center justify-between"><p className='font-semibold text-gray text-xs'>Copyright @2024 Apple Inc. All rights reserved.</p>
                  <div className="flex"></div>{footerLinks.map((link,i) => {
                      return (
